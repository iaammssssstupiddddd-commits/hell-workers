...
KINDS = ("Tank", "MudMixer", "RestArea", "SoulSpa", "WheelbarrowParking",
         "SandPile", "BonePile", "Door", "OutdoorLamp")
...
def read_building_art_static(data_dir: Path, *, expected_case: Case) -> tuple[dict | None, list[str]]:
    try:
        ...
        expected = {"records": expected_records(copies), "target_count": copies * 9,
        ...
        if (type(value["schema_version"]) is not int or value["schema_version"] != 1
                or value["contract_id"] != "building-art-static-nine-v2"
