"""Lazily imported performance-tool self-test corpus."""
...
from .fixtures import (
    ...
    build_rtt_light_projection_rows,
    canonical_sha256,
    ...
    expected_rtt_light_requested_environment,
    is_compatible_contract_predecessor,
    json,
    load_rtt_light_contract,
    load_valid_runs,
    measurement_duration_clock,
    observe_rtt_light_gate,
    project_rtt_light_runtime,
    ...
    read_window,
    recorded_rtt_light_repo_root,
    resolve_baseline_locator,
    rtt_light_checksum_text,
    sha256,
    shutil,
    summarize_session,
    tempfile,
    upgrade_rtt_light_baseline_index,
    validate_arguments,
    validate_gate_result_rows,
    validate_p08_cross_sidecar,
    ...
    write_json,
    write_p02_presentation_fixture,
