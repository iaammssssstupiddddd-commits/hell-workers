...
#[cfg(test)]
fn has_any_visual_cross_2x2(tiles: &[TerrainType], masks: &WorldMasks) -> bool {
    for y in 0..MAP_HEIGHT - 1 {
        for x in 0..MAP_WIDTH - 1 {
...
fn enforce_no_visual_cross_2x2(tiles: &mut [TerrainType], masks: &mut WorldMasks) {
...
fn post_process_tiles(tiles: &mut [TerrainType], masks: &mut WorldMasks, rng: &mut StdRng) {
