            ...
            [
                ...
                HelpEntry::new(
                    ...
                    [
                        ...
                        "完成した Wall と閉じた Door、Locked Door は光を遮り、開いた Door は光を通します。Lamp が給電されていない、Room 外にいる、または光が届かない場合は回復しません。",
                        "回復はゲーム時間が進んでいる間だけ適用されます。一時停止中も Door と室内の明るさ表示は更新されますが、Soul の回復は進みません。",
                    ],
                ),
            ],
        ),
