...
pub struct GameAssets {
    ...
    pub river_flow_noise: Handle<Image>,
    pub river_normal_like: Handle<Image>,
    pub terrain_blend_mask_soft: Handle<Image>,
    pub shoreline_detail: Handle<Image>,
    pub terrain_feature_lut: Handle<Image>,
    pub grass_macro_overlay: Handle<Image>,
    pub dirt_macro_overlay: Handle<Image>,
    pub sand_macro_overlay: Handle<Image>,
