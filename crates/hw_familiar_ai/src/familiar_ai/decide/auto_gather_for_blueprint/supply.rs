...
pub struct SupplyState {
    pub supply_by_owner: HashMap<(Entity, ResourceType), SupplyBucket>,
    pub candidate_sources: HashMap<(Entity, ResourceType, usize), Vec<SourceCandidate>>,
    pub stale_marker_only: HashSet<Entity>,
