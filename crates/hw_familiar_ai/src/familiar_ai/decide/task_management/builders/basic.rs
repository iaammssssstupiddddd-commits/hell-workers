...
pub fn issue_build(
    ...
    submit_assignment_with_source_entities(
        ...
        queries,
        shadow,
        TaskTarget { work_type: WorkType::Build, task_pos },
        assigned_task,
        &[ctx.task_entity],
        already_commanded,
    );
...
pub fn issue_collect_sand(
    ...
    submit_assignment_with_source_entities(
        ...
        queries,
        shadow,
        TaskTarget { work_type: WorkType::CollectSand, task_pos },
        assigned_task,
        &[ctx.task_entity],
        already_commanded,
    );
...
pub fn issue_refine(
    ...
    submit_assignment_with_source_entities(
        ...
        queries,
        shadow,
        TaskTarget { work_type: WorkType::Refine, task_pos },
        assigned_task,
        &[ctx.task_entity],
        already_commanded,
    );
...
pub fn issue_collect_bone(
    ...
    submit_assignment_with_source_entities(
        ...
        queries,
        shadow,
        TaskTarget { work_type: WorkType::CollectBone, task_pos },
        assigned_task,
        &[ctx.task_entity],
        already_commanded,
    );
...
pub fn issue_reinforce_floor(
    ...
    submit_assignment_with_source_entities(
        ...
        queries,
        shadow,
        TaskTarget { work_type: WorkType::ReinforceFloorTile, task_pos },
        assigned_task,
        &[ctx.task_entity],
        already_commanded,
    );
...
pub fn issue_pour_floor(
    ...
    submit_assignment_with_source_entities(
        ...
        queries,
        shadow,
        TaskTarget { work_type: WorkType::PourFloorTile, task_pos },
        assigned_task,
        &[ctx.task_entity],
        already_commanded,
    );
...
pub fn issue_coat_wall(
    ...
    submit_assignment_with_source_entities(
        ...
        queries,
        shadow,
        TaskTarget { work_type: WorkType::CoatWall, task_pos },
        assigned_task,
        &[ctx.task_entity],
        already_commanded,
    );
...
pub fn issue_frame_wall(
    ...
    submit_assignment_with_source_entities(
        ...
        queries,
        shadow,
        TaskTarget { work_type: WorkType::FrameWallTile, task_pos },
        assigned_task,
        &[ctx.task_entity],
        already_commanded,
    );
...
pub fn issue_move(
    ...
    submit_assignment_with_reservation_ops(
        ...
        queries,
        shadow,
        TaskTarget { work_type: WorkType::Move, task_pos },
        assigned_task,
        Vec::new(),
        already_commanded,
    );
