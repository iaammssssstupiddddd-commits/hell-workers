...
pub fn find_initial_gathering_position<G: SpatialGridOps, W: PathWorld>(
    center: Vec2,
    current_pos: Vec2,
...
pub fn find_gathering_wandering_target<G: SpatialGridOps, W: PathWorld>(
    center: Vec2,
    current_pos: Vec2,
    exclude_entity: Entity,
    soul_grid: &G,
...
pub fn find_gathering_still_retreat_target<G: SpatialGridOps, W: PathWorld>(
    center: Vec2,
    current_pos: Vec2,
    exclude_entity: Entity,
    soul_grid: &G,
