...
pub const WHEELBARROW_LEASE_MIN_DURATION_SECS: f64 = 8.0;
pub const WHEELBARROW_LEASE_MAX_DURATION_SECS: f64 = 45.0;
pub const WHEELBARROW_LEASE_BUFFER_RATIO: f64 = 0.5;
...
pub const WHEELBARROW_SCORE_PENDING_TIME: f32 = 2.0;
pub const WHEELBARROW_SCORE_PENDING_TIME_MAX_SECS: f64 = 30.0;
