---
name: review-help-impact
description: Use after implementing or changing functionality in hell-workers to inspect player-facing Help impact, update the Help catalog and exact approval when required, or validate a precise no-impact decision before completion.
---
