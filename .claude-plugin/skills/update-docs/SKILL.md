...
| 変更の種類 | 更新が必要なファイル |
|:--|:--|
| 型を crate に移動 | 移動先 crate の README・cargo_workspace.md・移動元 src README・関連実装ドキュメント（logistics.md 等） |
| logistics 系の型を hw_logistics に移動 | docs/logistics.md・crates/hw_logistics/README.md・src/systems/logistics/README.md |
| jobs 系の型を hw_jobs に移動 | docs/building.md・docs/tasks.md・crates/hw_jobs/README.md・src/systems/jobs/README.md |
| world 系の型を hw_world に移動 | crates/hw_world/README.md・src/systems/world/README.md |
| root ファイルをシェル化 | 対応する src/systems/*/README.md |
| crate 間依存を追加 | docs/architecture.md・docs/cargo_workspace.md |
