...
use crate::interface::ui::components::{HoverActionOverlay, MenuAction, MenuButton};
use crate::systems::jobs::{Building, BuildingCategory};
use bevy::prelude::*;

const HOVER_ACTION_Y_OFFSET: f32 = 38.0;

pub(crate) fn hover_action_button_system(
