...
| `context/mod.rs` | `TaskExecutionContext`, `TaskQueries`, `TaskAssignmentQueries` などをまとめて re-export する facade |
...
| `execute/task_execution/context/mod.rs` | context 系型の正規 root facade |
