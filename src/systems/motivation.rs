...
use crate::entities::familiar::{Familiar, ActiveCommand, FamiliarCommand, UnderCommand};
...
pub fn motivation_system(
    ...
    mut q_souls: Query<(&Transform, &mut DamnedSoul, &AssignedTask, Option<&UnderCommand>)>,
) {
