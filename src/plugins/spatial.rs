...
use hw_spatial::{
    ...
    update_familiar_spatial_grid_system, update_resource_spatial_grid_system, update_spatial_grid_system,
    ...
    fn build(&self, app: &mut App) {
        ...
        app.add_systems(
            ...
            (
                ...
                update_transport_request_spatial_grid_system::<crate::systems::logistics::transport_request::TransportRequest>,
            )
