...
pub const DREAM_TREE_MAGIC_CIRCLE_DURATION: f32 = 0.20;
pub const DREAM_TREE_GROWTH_DURATION: f32 = 0.35;
pub const DREAM_TREE_LIFE_SPARK_DURATION: f32 = 0.28;
pub const DREAM_TREE_MAGIC_CIRCLE_SCALE_START: f32 = 0.45;
pub const DREAM_TREE_MAGIC_CIRCLE_SCALE_END: f32 = 1.35;
pub const DREAM_TREE_GROWTH_SCALE_START: f32 = 0.05;
pub const DREAM_TREE_LIFE_SPARK_COUNT: u8 = 8;
pub const DREAM_TREE_LIFE_SPARK_SPEED_MIN: f32 = 18.0;
pub const DREAM_TREE_LIFE_SPARK_SPEED_MAX: f32 = 42.0;
pub const DREAM_TREE_LIFE_SPARK_START_RADIUS: f32 = 6.0;
pub const DREAM_TREE_LIFE_SPARK_SIZE: f32 = 8.0;
pub const DREAM_TREE_MAGIC_CIRCLE_COLOR: (f32, f32, f32, f32) = (0.55, 0.85, 1.0, 1.0);
pub const DREAM_TREE_GROWTH_GLOW_COLOR: (f32, f32, f32, f32) = (0.55, 0.82, 1.0, 1.0);
pub const DREAM_TREE_LIFE_SPARK_COLOR: (f32, f32, f32, f32) = (0.62, 0.92, 1.0, 1.0);
