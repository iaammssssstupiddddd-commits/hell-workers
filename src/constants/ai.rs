...
pub const STRESS_BREAKDOWN_FREEZE_SECS: f32 = 1.0;
...
pub const ESCAPE_PATHFINDING_SKIP_THRESHOLD_RATIO: f32 = 0.7;
...
pub const MAX_PATHFINDS_PER_FRAME: usize = 8;
pub const PATHFINDING_RETRY_COOLDOWN_FRAMES: u8 = 10;
