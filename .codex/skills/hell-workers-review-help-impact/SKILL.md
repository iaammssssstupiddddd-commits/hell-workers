...
description: Review completed hell-workers feature, bugfix, refactor, gameplay, input, UI, settings, notification, or runtime-data changes for player-facing Help impact. Update the root Help manifest, provider content, exhaustive coverage, exact approval snapshot, and affected docs when required; otherwise produce and validate a precise no-impact decision. Use after implementing, changing, or removing functionality and before reporting completion, committing, or publishing.
---
