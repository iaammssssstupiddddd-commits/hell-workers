...
- **Soul Energy システム（実装中）**: `crates/hw_energy` に型・定数・Relationship を集約。ロードマップは [plans/soul-energy/milestone-roadmap.md](plans/soul-energy/milestone-roadmap.md) を参照。
