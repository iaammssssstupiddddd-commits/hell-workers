...
- Resource: `Render3dVisible(pub bool)`（定義: `crates/bevy_app/src/lib.rs`、production Appへの初期登録: `main.rs`）
...
- Resource: `DebugInstantBuild(pub bool)`（定義: `crates/bevy_app/src/lib.rs`、production Appへの初期登録: `main.rs`）
...
| `crates/bevy_app/src/main.rs` | `DebugInstantBuild` の `init_resource` |
...
- Resource: `DebugVisible(pub bool)`（定義: `crates/bevy_app/src/lib.rs`、production Appへの初期登録: `main.rs`）
...
- `crates/bevy_app/src/main.rs` — デバッグ resource 初期登録とproduction App構成
