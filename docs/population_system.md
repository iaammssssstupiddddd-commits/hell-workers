...
関連実装は主に `src/entities/damned_soul/spawn.rs`、`src/systems/soul_ai/decide/drifting.rs`、および `src/systems/soul_ai/execute/mod.rs` 経由で公開される `hw_ai::soul_ai::execute::drifting` にあります。
