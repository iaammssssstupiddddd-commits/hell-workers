...
- [`../crates/hw_world/src/mapgen.rs`](../crates/hw_world/src/mapgen.rs): 生成エントリ
- [`../crates/hw_world/src/mapgen/types.rs`](../crates/hw_world/src/mapgen/types.rs): `GeneratedWorldLayout` 契約
- [`../crates/hw_world/src/mapgen/validate.rs`](../crates/hw_world/src/mapgen/validate.rs): lightweight / debug / post-resource validate
