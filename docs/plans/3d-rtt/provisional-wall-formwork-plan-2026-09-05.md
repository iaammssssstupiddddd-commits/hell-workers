...
- 次の作業: 同じcandidate bytesを使い、W-G01の混在gallery・Soul depthとW-L01 / W-L03 / W-A01〜A02の実機storyboard、W-L02のstateful storyboardを実装・採取する。Door側の単独gate後にJ1、M4へ進み、production回帰テストだけを実機合格へ読み替えない。
