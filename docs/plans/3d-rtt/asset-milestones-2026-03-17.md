...
- [ ] Bevy 側で `named_animations` 解決と AnimationGraph 再生確認は未着手

**ステータス**: [ ] コード側検証待ち（アセット配置済み）
...
- [ ] per-instance face material と `face_uv_offset` 更新経路は未実装

**ステータス**: [ ] コード側接続待ち（アセット配置済み）
