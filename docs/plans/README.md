...
`docs/plans` の文書ステータス一覧（更新日: 2026-08-16）。
...
| [3d-rtt/single-scene-light-field/05-indoor-light-save-lifecycle-plan-2026-08-03.md](3d-rtt/single-scene-light-field/05-indoor-light-save-lifecycle-plan-2026-08-03.md) | In Progress — implementation and native S1 complete; formal registration pending | FixtureMount保存、named rehydrate step、load／rollback fail-darkを導入するP05。 |
...
| [3d-rtt/single-scene-rtt-indoor-light-field-migration-plan-2026-08-03.md](3d-rtt/single-scene-rtt-indoor-light-field-migration-plan-2026-08-03.md) | In Progress — P05 implementation and native S1 complete; formal registration pending | Scene RtT 1枚、TopDown表示、放射状Indoor Light Fieldへの9分割親ロードマップ。 |
