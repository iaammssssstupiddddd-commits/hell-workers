...
| [3d-rtt/production-wall-art-plan-2026-08-31.md](3d-rtt/production-wall-art-plan-2026-08-31.md) | In Progress (M3) | active 3D wallをRough Vector Sketchの本番assetへ置き換え、制作・接続・実機受入・canonical昇格を一つの経路で閉じる計画。 |
