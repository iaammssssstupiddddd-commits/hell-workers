...
`docs/plans` の文書ステータス一覧（更新日: 2026-08-20）。
...
| [3d-rtt/single-scene-light-field/08-legacy-cleanup-release-plan-2026-08-03.md](3d-rtt/single-scene-light-field/08-legacy-cleanup-release-plan-2026-08-03.md) | Implementation in Progress — M1/M2 code cleanup complete / fresh P08 S0+S1 valid / RD0・reference bootstrap pending | Soul projector／section／legacy mirrorを撤去し、最終性能・Help gateを閉じるP08。 |
