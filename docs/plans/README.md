...
| [3d-rtt/single-scene-light-field/08-legacy-cleanup-release-plan-2026-08-03.md](3d-rtt/single-scene-light-field/08-legacy-cleanup-release-plan-2026-08-03.md) | Implementation in Progress — P01 remediation candidate focused pass / fresh P01 S0→formal and remaining reference bootstrap pending | Soul projector／section／legacy mirrorを撤去し、最終性能・Help gateを閉じるP08。 |
