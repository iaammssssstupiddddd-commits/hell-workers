...
`docs/plans` の文書ステータス一覧（更新日: 2026-08-14）。
...
| [3d-rtt/single-scene-light-field/03-indoor-light-domain-core-plan-2026-08-03.md](3d-rtt/single-scene-light-field/03-indoor-light-domain-core-plan-2026-08-03.md) | Implementation complete / formal evidence pending | 固定精度のradial field、遮光grid、supercover LOSを`hw_infra`へ実装するP03。 |
...
| [3d-rtt/single-scene-rtt-indoor-light-field-migration-plan-2026-08-03.md](3d-rtt/single-scene-rtt-indoor-light-field-migration-plan-2026-08-03.md) | In Progress — P00 / P01 / P02 / P02-A completed; P03 implementation complete / formal evidence pending | Scene RtT 1枚、TopDown表示、放射状Indoor Light Fieldへの9分割親ロードマップ。 |
