...
`docs/plans` の文書ステータス一覧（更新日: 2026-08-15）。
...
| [3d-rtt/single-scene-light-field/04-indoor-light-runtime-integration-plan-2026-08-03.md](3d-rtt/single-scene-light-field/04-indoor-light-runtime-integration-plan-2026-08-03.md) | In Progress — implementation complete; P04 formal native evidence pending | Wall／Door／給電／Roomのsnapshot、dirty管理、更新順を接続するP04。 |
...
| [3d-rtt/single-scene-rtt-indoor-light-field-migration-plan-2026-08-03.md](3d-rtt/single-scene-rtt-indoor-light-field-migration-plan-2026-08-03.md) | In Progress — P04 implementation complete; formal evidence pending | Scene RtT 1枚、TopDown表示、放射状Indoor Light Fieldへの9分割親ロードマップ。 |
