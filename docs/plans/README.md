...
`docs/plans` の文書ステータス一覧（更新日: 2026-09-08）。
...
| [3d-rtt/provisional-wall-formwork-plan-2026-09-05.md](3d-rtt/provisional-wall-formwork-plan-2026-09-05.md) | In Progress — M3b正式画像・性能、W-L01〜L02合格／W-L03・asset失敗系・J1待ち | 木製型枠6形状、タイル単位の本設mesh切替、混在接続と実機受入の計画。 |
