...
| [3d-rtt/single-scene-light-field/06-indoor-light-rendering-plan-2026-08-03.md](3d-rtt/single-scene-light-field/06-indoor-light-rendering-plan-2026-08-03.md) | Implementation complete — native S0 / S1 / formal pending clean committed subject | 100×100共有textureとTerrain／構造物receiverへLight Fieldを表示するP06。 |
...
| [3d-rtt/single-scene-rtt-indoor-light-field-migration-plan-2026-08-03.md](3d-rtt/single-scene-rtt-indoor-light-field-migration-plan-2026-08-03.md) | In Progress — P06 implemented; native formal pending clean subject | Scene RtT 1枚、TopDown表示、放射状Indoor Light Fieldへの9分割親ロードマップ。 |
