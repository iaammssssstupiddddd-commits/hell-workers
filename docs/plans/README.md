...
`docs/plans` の文書ステータス一覧（更新日: 2026-09-07）。
...
| [3d-rtt/provisional-wall-formwork-plan-2026-09-05.md](3d-rtt/provisional-wall-formwork-plan-2026-09-05.md) | In Progress — M3b正式画像18/18合格、lifecycle・性能・Memory待ち | 木製型枠6形状、タイル単位の本設mesh切替、混在接続と実機受入の計画。 |
