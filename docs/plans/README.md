...
| [orca-ui-lifecycle-plan-2026-09-23.md](orca-ui-lifecycle-plan-2026-09-23.md) | In Progress — 実Orcaの統括1tab経路を部分受入。再handoff防止と限定的な中断・再開・終了候補を追加。固定パネルからの全経路、A/B/review、実agent終了、配備は未受入。稼働版は変更しない | Orca UI・受付・終了ライフサイクル統合計画 |
