...
| 関連計画 | [優先開発ツール5項目の導入計画](../plans/priority-development-tools-plan-2026-09-13.md)（D01/D03/D05/D06/T01。その他は未計画） |
| 関連Issue/PR | N/A |
...
後続の実装ではD01/D03/D05/D06/T01の5項目を対象にした。導入状況・監査結果・GitHub上の未完受入は
[現行計画](../plans/priority-development-tools-plan-2026-09-13.md)を参照する。以下の棚卸しは導入前の調査記録である。
...
- 現在地: 調査提案。ツール導入やruntime移行は未着手であり、採用済みとは扱わない。
- D01/D03/D05/D06/T01は[優先開発ツール導入計画](../plans/priority-development-tools-plan-2026-09-13.md)へ展開済み。実装は未着手。その他の候補は本評価の条件に沿って個別に計画する。
