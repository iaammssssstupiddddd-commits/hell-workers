...
現在の RtT テクスチャは `RttTextures` リソースで 1280×720 固定として生成されている。ウィンドウサイズとテクスチャサイズが一致している前提で設計されているため、ウィンドウが変化すると以下の問題が生じる。
...
- Phase 3 で参照箇所が増えても `RttTextures` の更新が1箇所で完結する
