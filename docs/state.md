...
書き込み元: `arch_category_action_system`（`crates/bevy_app/src/interface/ui/interaction/mod.rs`）
...
- `crates/bevy_app/src/interface/ui/interaction/mod.rs` - ボタンによる状態遷移とモード表示更新
